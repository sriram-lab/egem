...
%data from seashore-ludlow study, contains drug names, drug sensitivity data for cell lines that were screened against all 4 hme inhibitors
...
grate_ccle_exp_soft_hmesign = NaN(length(exptidcelllinemediamatch),8); %contains acetylation flux based on basal metabolic state and impact of each hme inhibitor teatment
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if hmetransint
            for kk = 4:-1:1   % match drug order
                ...
                model2.c(rxnpos) = 0;
         %        [fluxstate_gurobi,grate_ccle_exp_soft_hmesign(i,kk)] =  constrain_flux_regulation(model2,onreactions1h,offreactions1h,kappa,rho,epsilon,MODE, epsilon2,minfluxflag); % impact on growth
                model2.c(rxnpos) = epsilon_methylation ;
                 ...
                 grate_ccle_exp_soft_hmesign(i,kk + 4) = fluxstate_gurobi(rxnpos); %acetylation flux
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            end
        end
        ...
        grate_ccle_exp_soft_hmesign(i,:) = NaN;
    end
end
...
save('VariablesSaved\grate_ccle_exp_soft_mesign', 'grate_ccle_exp_soft_hmesign');
%%
...
exptidcelllinemediamatch.Properties.VariableNames{'exptidcelllinemediamatch1'}= 'expt_id';
hme_auc_dat= array2table(hme_auc_dat);
hme_auc_dat.Properties.VariableNames{'hme_auc_dat1'}= 'expt_id';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    g1 = grate_ccle_exp_soft_hmesign(:, 5:8);
g1 = g1 - repmat(ignoreNaN(g1, @median,2),1,4); % 

hcommon1= array2table(hcommon1);
hcommon1.Properties.VariableNames{'hcommon1'}= 'expt_id';
