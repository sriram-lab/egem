...
for j = 5:13
    ...
    saveas(fig(1), ['./../figures/fig/me-model' nam '-corr-memodel.fig']);
    saveas(fig(1), ['./../figures/tiff/me-model' nam '-corr-memodel.tif']);
    ...
    legend boxoff;
    saveas(fig(1), ['./../figures/fig/me-model' nam '-media-memodel.fig']);
    saveas(fig(1), ['./../figures/tiff/me-model' nam '-media-memodel.tif']);
end
