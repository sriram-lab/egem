...
% Fill in empty reactions
min = addReaction(min,'SLC17A1','reactionName','Sodium/phosphate cotransporter 1',...
...
min = addReaction(min,'SLC17A3','reactionName','Sodium/phosphate cotransporter 4',...
    'reactionFormula','po4[e] + 3 na1[e] -> po4[c] + 3 na1[c]',...
    'subSystem','Transport, Extracellular',...
    'geneRule','(SLC17A1) or (SLC17A2) or (SLC17A3) or (SLC17A4)');
%% save
